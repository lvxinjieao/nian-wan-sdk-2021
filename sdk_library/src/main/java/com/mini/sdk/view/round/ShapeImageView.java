package com.mini.sdk.view.round;
...
public class ShapeImageView extends ImageView {
	...
	public ShapeImageView(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				Resources.getStyleableIntArray(context, "RoundImageViewByXfermode")
		/* R.styleable.RoundImageViewByXfermode */);

		mBorderRadius = a.getDimensionPixelSize(
				Resources.getStyleableFieldId(context, "RoundImageViewByXfermode", "borderRadius")
		...
		Logs.e(mBorderRadius + "");
		type = a.getInt(Resources.getStyleableFieldId(context, "RoundImageViewByXfermode",
				"type")/* R.styleable.RoundImageViewByXfermode_type */, TYPE_CIRCLE);// 默认为Circle
