...
//	private boolean mUseIntrinsicAnimation;
	...
	private void initView(Context context, AttributeSet attrs) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context)
				.inflate(Resources.getLayoutId(context, "xlistview_header"), null);
		addView(mContainer, lp);
		setGravity(Gravity.BOTTOM);

		mArrowImageView = (ImageView) findViewById(Resources.getId(context, "xlistview_header_arrow"));
//		mHintTextView = (TextView)findViewById(
//				MCHInflaterUtils.getId(context, "xlistview_header_tip_textview"));
		mHintTextView = (TextView) findViewById(Resources.getId(context, "xlistview_header_hint_textview"));
		mProgressBar = (ProgressBar) findViewById(Resources.getId(context, "xlistview_header_progressbar"));
...
//		}
////        SuningLogs.e("scaleOfLayout = " + scaleOfLayout + " angle = " + angle);
...
//		}
		...
		case STATE_NORMAL:
			...
			mArrowImageView.setVisibility(View.VISIBLE);
			mArrowImageView.setImageResource(Resources.getDrawableId(context, "xlistview_down_arrow"));
...
//			}
		...
		case STATE_READY:
			mProgressBar.setVisibility(View.GONE);
			mArrowImageView.setVisibility(View.VISIBLE);
			mArrowImageView.setImageResource(Resources.getDrawableId(context, "xlistview_up_arrow"));
