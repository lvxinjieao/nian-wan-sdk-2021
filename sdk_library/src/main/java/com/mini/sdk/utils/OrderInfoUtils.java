...
public class OrderInfoUtils {
	...
	// public static String MCH_MD5KEY = Constant.getInstance().getMCHKEY();//
	// 和服务器验证用的md5key
	 ...
	 * @return
	 */
	public static String createZFBOrderInfo(String zfbshopid, String zfbshopname, String tradeNo, String goodsName,
			String body, String price, String zfbansynoticeurl) {
		...
		Logs.w("fun#createZFBOrderInfo orderInfo = " + orderInfo);
		return orderInfo;
	}
	...
	public static String getRandomNumber() {
		...
		Logs.w("fun#getRandomNumber key = " + key);
