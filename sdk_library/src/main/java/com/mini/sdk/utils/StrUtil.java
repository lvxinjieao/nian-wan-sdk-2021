...
public class StrUtil {
	...
	public static SpannableString addLine(SpannableString msp) {
		// 设置下划线
		msp.setSpan(new UnderlineSpan(), 0, msp.toString().length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return msp;
	}
	 ...
	 * @return
	 */
	public static SpannableString addLine(SpannableString msp, int start, int end) {
		// 设置下划线
		msp.setSpan(new UnderlineSpan(), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return msp;
	}
	 ...
	 *
	 * @param str
	 * @param color ＝ 0xffff00ff
	 * @return
	 */
	public static SpannableString addColor(String str, int color) {
		SpannableString msp = new SpannableString(str);
		// 设置字体前景色
		msp.setSpan(new ForegroundColorSpan(color), 0, str.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return msp;
	}
	 ...
	 *
	 * @param str
	 * @param color = 0xff00ffff
	 * @param start
	 * @param end
	 * @return
	 */

	public static SpannableString addColor(String str, int color, int start, int end) {
		SpannableString msp = new SpannableString(str);
		// 设置字体前景色
	...
	public static SpannableString addBagColor(String str, int color) {
		SpannableString msp = new SpannableString(str);
		msp.setSpan(new BackgroundColorSpan(color), 0, str.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置背景色为青色
		return msp;
	}
	 ...
	 * @return
	 */
	public static SpannableString addBagColor(String str, int color, int start, int end) {
		SpannableString msp = new SpannableString(str);
	...
	public static SpannableString addColor(SpannableString msp, int color) {
		// 设置字体前景色
		msp.setSpan(new ForegroundColorSpan(color), 0, msp.toString().length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return msp;
	}
	...
	public static SpannableString addColor(SpannableString msp, int color, int start, int end) {
		// 设置字体前景色
		msp.setSpan(new ForegroundColorSpan(color), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		return msp;
	}
	...
	public static SpannableString addBagColor(SpannableString msp, int color) {
		msp.setSpan(new BackgroundColorSpan(color), 0, msp.toString().length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置背景色为青色
		return msp;
	}
	 ...
	 * @return
	 */
	public static SpannableString addBagColor(SpannableString msp, int color, int start, int end) {
		msp.setSpan(new BackgroundColorSpan(color), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 设置背景色为青色
		return msp;
	...
	public void score() {
		...
		// 设置项目符号
		msp.setSpan(new BulletSpan(BulletSpan.STANDARD_GAP_WIDTH, Color.GREEN), 0, msp.length(),
				Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); // 第一个参数表示项目符号占用的宽度，第二个参数为项目符号的颜色
		// 设置图片
		/*
		 * Drawable drawable = getResources().getDrawable(R.drawable.ic_launcher);
		 * drawable.setBounds(0, 0, drawable.getIntrinsicWidth(),
		 * drawable.getIntrinsicHeight()); msp.setSpan(new ImageSpan(drawable), 53, 57,
