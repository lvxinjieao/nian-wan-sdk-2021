...
public class PTBPayResultDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View containerView = inflater.inflate(Resources.getLayoutId(context, "dialog_coin_pay_result"), container,
                false);
        // 如果有信息,显示加载信息
        ...
        // TextView tvMoney1 = (TextView)
        // containerView.findViewById(Resources.getId(context,
        // "tv_mch_ptb_pay_result"));
        TextView tvMoney2 = (TextView) containerView.findViewById(Resources.getId(context, "tv_mch_ptb_pay_result2"));
        TextView tvGoodsName = (TextView) containerView
                .findViewById(Resources.getId(context, "tv_mch_ptb_pay_goodsname"));
        TextView tvTradeWay = (TextView) containerView.findViewById(Resources.getId(context, "tv_mch_ptb_pay_way"));
        TextView tvTradeNo = (TextView) containerView.findViewById(Resources.getId(context, "tv_mch_ptb_pay_order_no"));
        ...
        Button btnSure = (Button) containerView.findViewById(Resources.getId(context, "btn_mch_ptb_pay_sure"));
    ...
    public static class Builder {
        ...
        public PTBPayResultDialog show(Context context, FragmentManager fm) {
            ...
            Logs.d("show PTBPayResultDialog.");
