...
import com.mini.sdk.interfaces.OppoIDInterface;
...
public class OppoDeviceIDHelper {
    ...
    private String realoGetIds(String str) {
        ...
        if (sign == null) {
            ...
            try {
                signatures = mContext.getPackageManager().getPackageInfo(pkgName, PackageManager.GET_SIGNATURES).signatures;
            } catch (Exception e) {
                e.printStackTrace();
                signatures = null;
            }
